            ...
            <div style={{ position: 'relative' }}>
              ...
              {showProfile && (
                <div style={{ position: 'absolute', top: '100%', right: 0, width: 200, background: '#fff', border: '1px solid var(--border)', borderRadius: 8, boxShadow: '0 10px 30px rgba(0,0,0,.15)', zIndex: 600, marginTop: 10, padding: 8 }}>
                  ...
                  <button onClick={() => { navigate('/consultor/perfil'); setShowProfile(false) }} style={{ width: '100%', padding: '10px 12px', display: 'flex', alignItems: 'center', gap: 8, border: 'none', background: 'none', color: 'var(--ink)', fontSize: '.8rem', fontWeight: 600, cursor: 'pointer', borderRadius: 4 }}
